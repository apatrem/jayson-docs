...
- Design decisions. Types. Examples. One worked block.
...
| The 33 settled decisions | [`docs/DECISIONS.md`](docs/DECISIONS.md) |
...
| A working block, ready to copy | [`reference/callout/`](reference/callout/) |
